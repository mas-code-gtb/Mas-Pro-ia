...
const EditPurchase = () => {
  ...
  const fetchPurchase = async () => {
    try {
      ...
      const response = await axios.get(`https://maspro-backend.onrender.com/api/purchases/purchase-orders/${id}/`, config);
      setFormData({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://maspro-backend.onrender.com/api/purchases/purchase-orders/${id}/`, purchaseData, config);
