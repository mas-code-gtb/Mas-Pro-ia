...
const AddPurchase = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://maspro-backend.onrender.com/api/purchases/purchase-orders/', purchaseData, config);
      ...
      for (const line of validLines) {
        ...
        const lineResponse = await axios.post(
          `https://maspro-backend.onrender.com/api/purchases/purchase-orders/${purchaseId}/add_line/`,
          lineData,
          config
        );
