...
const EditCompany = () => {
  ...
  const fetchCompany = async () => {
    try {
      ...
      const response = await axios.get(`http://127.0.0.1:8000/api/companies/companies/${id}/`, config);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://127.0.0.1:8000/api/companies/companies/${id}/`, formData, config);
