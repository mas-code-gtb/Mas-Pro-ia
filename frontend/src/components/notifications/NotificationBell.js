...
const NotificationBell = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await axios.get('http://127.0.0.1:8000/api/notifications/notifications/', config);
  ...
  const fetchUnreadCount = async () => {
    try {
      ...
      const response = await axios.get('http://127.0.0.1:8000/api/notifications/notifications/unread_count/', config);
  ...
  const markAsRead = async (id) => {
    try {
      ...
      await axios.post(`http://127.0.0.1:8000/api/notifications/notifications/${id}/mark_read/`, {}, config);
  ...
  const markAllRead = async () => {
    try {
      ...
      await axios.post('http://127.0.0.1:8000/api/notifications/notifications/mark_all_read/', {}, config);
